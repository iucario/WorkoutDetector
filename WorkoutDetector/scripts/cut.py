...
def cut_video(input_dir, vid, start_sec, end_sec, output_dir):
    input_file = os.path.join(input_dir, f'{vid}.mp4')
    output_file = os.path.join(output_dir, f'{vid}_{start_sec}.mp4')
